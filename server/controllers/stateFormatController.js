const stateFormatServices= require('../services/stateFormatServices');
exports.check = async (req, res, next) => {
    try {
        console.log(req.body)
        // const getcols = req.body;
        const result = await stateFormatServices.SelectedCode(req.body.filename,req.body.attributes);
    //  console.log(result)
